...
for s in steps:
    ...
    plt.axis('off')
    temp = []
    filt = ((xm-0.5)**2 + (ym-0.5)**2)<0.2**2
    cyls.append(-np.log(1.0-np.mean(1.0 - np.exp( - h_dust[filt] / dust_norm))))
    #
